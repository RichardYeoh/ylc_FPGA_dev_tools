    ...
    if(MASTER_RST) begin
      ...
      case(wr_state)
        ...
        S_WA_WAIT: begin
          ...
          if(!WR_FIFO_AEMPTY | (reg_wr_len[31:7] == 25'd0)) begin
            wr_state          <= S_WA_START;
          end
		  rd_first_data <= 1'b0;
        end
        S_WA_START: begin
          ...
          reg_wr_len[31:7]    <= reg_wr_len[31:7] - 25'd1;
          //if(reg_wr_len[31:11] != 21'd0) begin
          if(reg_wr_len[31:7] != 25'd0) begin
            reg_w_len[7:0]  <= 8'h0F;
            reg_w_last      <= 1'b0;
            reg_w_stb[7:0]  <= 8'hFF;
          end else begin
        ...
        S_WR_WAIT: begin
          ...
          //  reg_wr_status[1:0]  <= reg_wr_status[1:0] | M_AXI_BRESP[1:0];
            if(reg_w_last) begin
              ...
              wr_state          <= S_WA_WAIT;
              //reg_wr_adrs[31:0] <= reg_wr_adrs[31:0] + 32'd2048; //256*8
              reg_wr_adrs[31:0] <= reg_wr_adrs[31:0] + 32'd128;  //16*8
            end
          //end
        end
        S_WR_DONE: begin
    ...
    if(!ARESETN) begin
      ...
      case(rd_state)
        ...
        S_RA_START: begin
          ...
          reg_rd_len[31:7] <= reg_rd_len[31:7] -25'd1;
          if(reg_rd_len[31:7] != 25'd0) begin
            reg_r_last      <= 1'b0;
          ...
          if(M_AXI_RVALID) begin
            if(M_AXI_RLAST) begin
              if(reg_r_last) begin
                ...
                reg_rd_adrs[31:0] <= reg_rd_adrs[31:0] + 32'd128;
              end
            end else begin
